      ...
      <Navigation userImg={userData.userImg} />
        ...
        <Header userName={userData.userFirst} />
          <div className="body about">
            ...
            <ul>
                <li>Euso (<a href="https://github.com/Euso23">GitHub</a>)</li>
                <li>Kevin (<a href="https://github.com/KevinTravels">GitHub</a>)</li>
                <li>Ray (<a href="https://github.com/RayRoams">GitHub</a>)</li>
                <li>Admeh (<a href="https://github.com/AdmehAdventures">GitHub</a>)</li>
            </ul>
