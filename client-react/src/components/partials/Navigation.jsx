  ...
  return (
    <div className="Navigation">
      <div>
        ...
        <Button fullWidth={true} sx={navBtnStyle} href="/" size="small"><i className="bi bi-house-fill"></i></Button>
        <Button fullWidth={true} sx={navBtnStyle} href="/survey" size="small"><i className="bi bi-suitcase2-fill"></i></Button>
        <Button fullWidth={true} sx={navBtnStyle} href="/schedule/1" size="small"><i className="bi bi-calendar2-week-fill"></i></Button>
